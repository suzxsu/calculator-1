...
import (
	calculator "calculator/gen/proto/calculator"
	context "context"
	errors "errors"
...
type CalculatorServiceClient interface {
	...
	Calculate(context.Context, *connect_go.Request[calculator.CalculateRequest]) (*connect_go.Response[calculator.CalculateResponse], error)
}
...
func NewCalculatorServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) CalculatorServiceClient {
	...
	return &calculatorServiceClient{
		calculate: connect_go.NewClient[calculator.CalculateRequest, calculator.CalculateResponse](
			httpClient,
...
type calculatorServiceClient struct {
	calculate *connect_go.Client[calculator.CalculateRequest, calculator.CalculateResponse]
}

// Calculate calls calculator.CalculatorService.Calculate.
func (c *calculatorServiceClient) Calculate(ctx context.Context, req *connect_go.Request[calculator.CalculateRequest]) (*connect_go.Response[calculator.CalculateResponse], error) {
...
func (UnimplementedCalculatorServiceHandler) Calculate(context.Context, *connect_go.Request[calculator.CalculateRequest]) (*connect_go.Response[calculator.CalculateResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("calculator.CalculatorService.Calculate is not implemented"))
}
